<template>
  <form v-on:submit.prevent="submitForm" class="eventForm"> 
    ...
    <div class="form-group">
      ...
      <input id="title" type="text" class="form-control" v-model="event.name" autocomplete="off" />
    </div> 
       <div class="form-group">
      <label for="title"> Event Host: </label>
      <input id="title" type="text" class="form-control" v-model="event.host" autocomplete="off" />
    </div>
    ...
    <div class="form-group">
      ...
      <input id="playlist" type="text" class="form-control" v-model="event.playlist" autocomplete="off" />
    </div> 
    <div class="form-group">
      <label for="date">Date:</label>
      <textarea id="date" class="form-control" v-model="event.date"></textarea>
    </div> 
     <div class="form-group">
      <label for="time"> Start time: </label>
      <textarea id="time" class="form-control" v-model="event.time"></textarea>
    </div> 
      <div class="form-group">
      <label for="time"> Length of Event in Minutes: </label>
      <textarea id="time" class="form-control" v-model="event.duration"></textarea>
    </div> 
      <div class="form-group">
      <label for="location"> Location: </label>
      <textarea id="location" class="form-control" v-model="event.location"></textarea>
    </div>
